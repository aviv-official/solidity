...
contract IEstate /* is ERC721Full */{
    ...
    */
    ...
    /**
    * @dev get the list of all tokens an address is proxy or agent for
    */
    ...
    //If there are a large number of proxies to the agent, 
    //This has a non-zero chance of running out of gas even with the block gas maximum
    //Therefore, do not call this from within a contract, or your contract could potentially brick.
    //Instead, use getProxies periodically to cache then order them by balance, as needed 
    //or call this function from an external oracle and post the results back to your contract
